...
sys.path.append("../..")
sys.path.append("../../")
from ui_test.page import AccountManagePage, Login, PoolManagePage, ProjectManagePage, PackageManageTab, AppManageTab, AppPublishTab
...
class TestOrgAdmin(unittest.TestCase):
    ...
    #     # 登录
        ...
        publish_app_tab.create_new_version_customed_config(publish_description, version1, package_path, package_params, pool_name)
